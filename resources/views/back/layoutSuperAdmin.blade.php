                        ...
                        <div class="">
                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                <li class="dropdown top-menu-item-xs">
                                    <a href="" class="dropdown-toggle profile waves-effect waves-light" data-toggle="dropdown" aria-expanded="true"><img src="/back/assets/images/users/avatar-1.jpg" alt="user-img" class="img-circle"> </a>
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="/admin" class="waves-effect"><i class="fa fa-dashboard"></i> <span> Dashboard </span></span></a>
                            </li>
                            <li class="has_sub">
                                <a href="/admin/confirm" class="waves-effect"><i class="fa fa-sticky-note"></i> <span> Confirm </span></span></a>
                            </li>
                            <li class="has_sub">
